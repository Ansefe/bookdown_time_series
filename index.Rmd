...
Dado que sabemos que el **SNR** es aprox **123**, esto significa que el ruido es aprox 1/123 = **0.08** que nos da una idea del máximo error absoluto (**MAE**) en los datos Normalizados en el pronósitco del siguiente periodo que podemos obtener, ya que errores por debajo de este valor probablemente incluirían la predicción del ruido y podrían ser indicador de overfitting en el modelo predictivo usado.
